        ...
        if(unionId != null) {
            ...
            if(appUser != null && appUser.getStatus() == Constant.USER_STATUS_ACTIVE) {
                try {
                    ...
                    if(StringUtils.isNotEmpty(appUser.getTeamName())) user.setTeamName(appUser.getTeamName());
                    if(StringUtils.isNotEmpty(appUser.getTeamNo())) user.setTeamNo(appUser.getTeamNo());
                    if(appUser.getTeamId() != null) user.setTeamId(appUser.getTeamId());
